      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="/Rios.Matias/Paginas/IngresoVehiculo.php">Check-IN</a>
            </li>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/Rios.Matias/Paginas/Facturar.php">Check Out</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/Rios.Matias/Funciones/LeerUsuarios.php">Listar Usuarios</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/Rios.Matias/Funciones/LeerVehiculos.php">Listar Vehiculos</a>
            </li>
            <li class="nav-item active">
